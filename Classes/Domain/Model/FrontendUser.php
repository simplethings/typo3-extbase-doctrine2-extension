...
class Tx_Doctrine2_Domain_Model_FrontendUser extends Tx_Doctrine2_DomainObject_AbstractEntity {
	 ...
	 *
	 * @param Tx_Doctrine2_Persistence_ObjectStorage<Tx_Doctrine2_Domain_Model_FrontendUserGroup> $usergroup An object storage containing the usergroups to add
	 * @return void
	 * @api
	 */
	 ...
	 *
	 * @param Tx_Doctrine2_Domain_Model_FrontendUserGroup $usergroup
	 * @return void
	 * @api
	 */
	 ...
	 * although it can hold several usergroups.
	 *
	 * @return Tx_Doctrine2_Persistence_ObjectStorage An object storage containing the usergroup
	 * @api
	 * @deprecated since Doctrine2 1.3.0; will be removed in Doctrine2 1.5.0 - use Tx_Doctrine2_Domain_Model_FrontendUser::getUsergroup() instead
	 */
